function resized_patch = sample_patch(im, pos, sample_sz, output_sz, use_mexResize)
...
xs = floor(pos(2)) + (1:sample_sz(2)) - floor((sample_sz(2)+1)/2);
ys = floor(pos(1)) + (1:sample_sz(1)) - floor((sample_sz(1)+1)/2);
